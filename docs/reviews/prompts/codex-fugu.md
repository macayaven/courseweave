...
names. Perform the requested architecture and implementation-plan review, with
special attention to subtle requirement gaps, consent invariants, and whether
the plan can actually be completed test-first.
