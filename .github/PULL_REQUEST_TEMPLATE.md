...
List the exact commands run and observed results. State which installed,
provider, accessibility, course, or human checks were not run.
...
- [ ] No credentials, learner data, private paths, or raw provider logs are included.
